...
export default {
  ...
  methods: {
    async getList () {
      ...
      var jie = await NoticTypeSv.getNoticTypes(this.listQuery);
      this.list = jie.data;
    ...
    async createData () {
      this.$refs['dataForm'].validate(async (valid) => {
        if (valid) {
          console.log(this.temp);
          var jie = await NoticTypeSv.insertNoticType(this.temp);
          if (jie.code == 20000) {
    ...
    async updateData () {
      this.$refs['dataForm'].validate(async (valid) => {
        if (valid) {
          ...
          var jie = await NoticTypeSv.updateNoticType(tempData);
          if (jie.code == 20000) {
