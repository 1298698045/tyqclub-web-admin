  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        <el-form-item label="名称" style="padding-right: 30px;">
          <el-input v-model="listQuery.search" placeholder="等级名称" style="width: 200px;" class="filter-item"
    ...
    <el-table :key="tableKey" v-loading="listLoading" :data="list" stripe fit highlight-current-row style="width: 100%;"
      ...
      <el-table-column label="是否默认等级" min-width="50px" align="center">
        <template slot-scope="{row}">
              <input  type="checkbox" id="reading" value="reading" v-model="row.isDefault" disabled>
        </template>
      </el-table-column>
      <el-table-column label="等级描述" min-width="70px" align="center" sortable>
        <template slot-scope="{row}">
          <span>{{ row.description }}</span>
        </template>
      </el-table-column>
       <el-table-column label="拥有人数" min-width="70px" align="center" sortable>
        <template slot-scope="{row}">
          <span>{{ row.memberCount }}</span>
        </template>
      </el-table-column>
        <el-table-column label="创建日期" min-width="70px" align="center" sortable>
        <template slot-scope="{row}">
    ...
    <!-- 页码 -->
    <pagination v-show="total > 0" :total="total" :page.sync="listQuery.page" :rows.sync="listQuery.rows"
      @pagination="getList" />
